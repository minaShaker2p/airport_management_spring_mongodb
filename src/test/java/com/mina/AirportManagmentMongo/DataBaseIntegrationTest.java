...
public class DataBaseIntegrationTest {
    ...
    public void beforeEach() {
        ...
        flightTwo.setDepartureCity(venice);
        flightTwo.setDestinationCity(rome);
        flightTwo.setDepartureDate(LocalDate.of(2019, 5, 11));
        flightTwo.setFlightType(FlightType.Internal);
    ...
    @Test
    public void findByMinAircraftNbSeatsShouldSuccess()
    {
        // arrange
        int minSeats=200;

        // act
        List<FlightInformation> flights = flightInformationRepository.findByMinAircraftNbSeats(minSeats);
    ...
    public void theCascadeOnSaveShouldWork() {
        ...
        flight.setFlightType(FlightType.International);
